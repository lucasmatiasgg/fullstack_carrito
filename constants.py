...
RESPONSE_CODE_ERROR_INVALID_CREDENTIALS=20
RESPONSE_CODE_ERROR_INVALID_PASSWORD=21

RESPONSE_CODE_ERROR_USERNAME_ALREADY_EXISTS=16
...
RESPONSE_MESSAGE_ERROR_INVALID_PASSWORD='La contraseña ingresada es incorrecta'

RESPONSE_MESSAGE_ERROR_USERNAME_ALREADY_EXISTS='El nombre de usuario no está disponible'
RESPONSE_MESSAGE_ERROR_INVALID_CREDENTIALS="Usuario o password inválido"